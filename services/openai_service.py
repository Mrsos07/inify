...
"""
        ...
        mandatory_override = """
═══════════════════════════════════════════════════════════
🚨 قاعدة إلزامية لا تُخالَف أبداً:
═══════════════════════════════════════════════════════════
إذا كانت بيانات العقارات موجودة في هذا الـ prompt:
✅ أجب على أي سؤال عن تفاصيل العقار (مصعد، موقف، تكييف، دور، عمر، حديقة، مسبح، شرفة...) مباشرة من البيانات.
❌ لا تطلب المدينة أو الحي إذا كانت العقارات موجودة أمامك.
❌ لا تتهرب من الإجابة المباشرة.
"""
        return prompt + agent_info + datetime_info + mandatory_override
...
- لا تطلب المدينة أو الحي إذا كانت العقارات موجودة في البيانات أعلاه!
- لا تتهرب من الإجابة المباشرة بطلب معلومات إضافية غير ضرورية!
- اقرأ البيانات جيداً قبل الرد!

✅ قاعدة ذهبية: إذا كانت المعلومة موجودة في بيانات العقارات أعلاه → أجب عنها فوراً ومباشرة.
"""
